...
function sendCartToWhatsApp() {
    ...
    // Replace with the owner's WhatsApp number (include country code, e.g., +27123456789)
    const ownerWhatsAppNumber = "+27123456789"; // Replace with the actual number

    // Open WhatsApp with the pre-filled message
    const whatsappURL = `https://wa.me/${+27762609804}?text=${encodedMessage}`;
